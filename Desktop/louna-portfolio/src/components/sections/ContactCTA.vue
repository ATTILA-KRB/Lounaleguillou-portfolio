  ...
  <section class="px-6 md:px-16 py-16 sm:py-20 md:py-28 bg-fg text-accent-fg fade-in">
    <div class="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 items-center">
      ...
      <h2 class="lg:col-span-7 font-heading text-[2.5rem] md:text-[3rem] font-normal leading-[1.05] fade-in">
        Envie de <em class="italic text-accent">collaborer</em> ?
      </h2>

      <!-- Right — 5 cols -->
      <div class="lg:col-span-5 flex flex-col gap-6 fade-in" style="transition-delay: 150ms;">
        <p class="text-white/60 text-[0.95rem] leading-[1.7]">
        ...
        <div class="flex gap-6">
          <a
            ...
            target="_blank"
            rel="noopener"
            class="text-[0.65rem] font-medium uppercase tracking-[0.2em] text-white/50 hover:text-accent transition-colors duration-500"
          >
            LinkedIn
          </a>
        </div>
