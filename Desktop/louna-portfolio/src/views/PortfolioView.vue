  ...
  <div>
    <section class="px-6 sm:px-8 md:px-16 pt-24 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20">
      <div class="max-w-[1600px] mx-auto fade-in">
        ...
        <h1 class="font-heading text-[2.2rem] sm:text-[3rem] md:text-[4.5rem] font-normal leading-[0.95] mb-6 sm:mb-8 md:mb-12">
        ...
        <!-- Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-10 fade-in" style="transition-delay: 150ms;">
